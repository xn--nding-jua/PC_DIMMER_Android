...
public class Stageview extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_stageview, container, false);
    }

    public void onViewCreated(View v, Bundle savedInstanceState) {
        super.onViewCreated(v, savedInstanceState);

        mCallbackToMain.StageviewCallbackToMain(R.layout.fragment_stageview);
    }
    ...
    public interface CallbackToMain {
        void StageviewCallbackToMain(int Cmd); // call self-defined function in main-program
    }
}
